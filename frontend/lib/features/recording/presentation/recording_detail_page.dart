              ...
              : ListView(
                  ...
                  children: [
                    if (_meta != null) ...[
                      ...
                      Text(
                        'Duration: ${_meta!['durationSec'] ?? '—'}s · segments: ${_meta!['segmentCount'] ?? _segments.length}',
                    ...
                    if (_player != null && _player!.value.isInitialized) ...[
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: VideoProgressIndicator(_player!, allowScrubbing: true),
                          ),
                        ],
                      ),
                      const SizedBox(height: 12),
                    ...
                    if (_segments.isEmpty)
                      ...
                      ..._segments.asMap().entries.map((e) {
                        ...
                        final active = url != null && url == _playingUrl;
                        return Card(
