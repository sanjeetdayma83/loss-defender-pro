...
class _UsersScreenState extends State<UsersScreen> {
  ...
  List<dynamic> get _filtered {
    ...
    if (q.isNotEmpty) {
      list = list.where((u) {
        ...
        final s =
            '${u['name']} ${u['email']} ${u['role']} ${u['phone']}'.toLowerCase();
        return s.contains(q);
      }).toList();
    }
    switch (_tab) {
  ...
  Future<void> _invite() async {
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: roles
                      .map((e) => DropdownMenuItem(
                          value: e, child: Text(_roleLabel(e))))
                      .toList(),
    ...
    try {
      ...
      // fallback if invite path differs
      try {
  ...
  Widget build(BuildContext context) {
    ...
    final admins = _countRole(
        (r, _) => r == 'owner' || r == 'super_admin' || r == 'manager');
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                        'Manage team members, assign roles and control warehouse access.',
                        style: TextStyle(
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                _tabChip(
                    'Operators (${_countRole((r, _) => r.contains('operator') || r == 'supervisor')})',
                    'operators'),
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          _row(Icons.badge_outlined, 'Employee ID',
          ...
          OutlinedButton.icon(
            ...
            icon: Icon(
              status == 'active' ? Icons.person_off : Icons.person,
              size: 18,
